      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-4 tag">
          <div class="panel panel-default">
            ...
            <div class="panel-body tag-body">
              <img src="img/tags/14.jpg" alt="Estate" class="img-responsive" />
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-12 col-md-4 tag">
          <div class="panel panel-default">
            ...
            <div class="panel-body tag-body">
              <img src="img/tags/8.jpg" alt="Estate" class="img-responsive" />
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-12 col-md-4 tag">
          <div class="panel panel-default">
            ...
            <div class="panel-body tag-body">
              <img src="img/tags/2.jpg" alt="Estate" class="img-responsive" />
            </div>
          </div>
        </div>
